...
- **Industry:** Salud privada — diseño y research de producto digital
- **Technical literacy:** alta
- **Experience level:** intermedia (5 años en UX, antes diseñadora de servicios en una agencia)

## Goals

- Dedicar su tiempo a research que genere conocimiento nuevo (entrevistas, pruebas de usabilidad), no a etiquetar lo que ya llegó.
- Que los hallazgos se ubiquen en un paso del journey (buscar hora, pagar, ver resultados) y no queden como motivos sueltos, para que diseño sepa dónde intervenir.
- Que la evidencia cualitativa llegue al backlog con el mismo peso que un dato de negocio.
- Consolidarse como la referencia de "qué le pasa al paciente" dentro de producto.
...
- Revisión de comentarios de tiendas de apps y de Usabilla.

## Device preferences

MacBook como herramienta principal; vive en Figma, Miro y Excel (donde hace la codificación). Usa Usabilla y Google Analytics para contexto. Adoptaría una herramienta nueva si le ahorra la codificación y le deja corregir, pero la abandona si le exige mantener otro diccionario.
